<div class="row">
    ...
    <div class="form-check d-flex align-items-center mb-2 mt-2 mt-md-0 ms-auto">
        <input class="form-check-input form-lg-check me-2" type="checkbox" value="1" id="isPatientAccount"
            name="is_patient_account">
...
<div class="form-group col-sm-6">
    ...
    {{ Form::text('Last Name', null, ['class' => 'form-control','required', 'id' => 'adminAppointmentPlanId','placeholder' => __('Plan Type')]) }}
</div>
    ...
    <div class="form-group">
        ...
        <div class="position-relative">
            <input type="text" id="templateAppointmentDate" name="date" class="form-control bg-white"
                ...
                placeholder="{{ __('messages.doctor.select_date') }}" autocomplete="true" disabled readonly>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="d-flex align-items-center">
                <div class="form-check d-flex align-items-center mb-2">
                    <input class="form-check-input form-check-danger me-2 mt-0" type="checkbox" value=""
                        id="defaultCheck1">
                ...
                <div class="form-check d-flex align-items-center mb-2 ms-3">
                    <input class="form-check-input form-check-success me-2 mt-0" type="checkbox" value=""
                        id="defaultCheck1">
                    <label class="form-check-label fw-light fs-small" for="defaultCheck1">
...
<div class="row col-md-12 mb-3">
    <div class="col-3">
        <div><input id="paymentMethod" type="radio" name="PayPall" value="PayPall"><span class="radio-btn">PayPall</span></div>
    </div>
...
<div class="row col-md-12 mb-3">
    <div class="col-3">
        <div><input id="paymentMethod" type="radio" name="Stripe" value="Stripe" ><span class="radio-btn">Stripe
                Checkout</span></div>
    </div>
    <div class="col-md-6 col-sm-10 col-xs-10 centerize-col text-center social-icons-style-09">
        <ul class="xl-icon mb-0" style="display:flex; place-content:start;">
...
<div class="text-center col-12">
    <p class="text-uppercase mb-sm-4 mb-0 d-none" id="payableAmountText">{{__('messages.appointment.payable_amount')}} :
        <span class="fw-bold" id="payableAmount">{{__('messages.common.n/a')}}</span>
    </p>
</div>

<div class="col-12 text-center">
    <button class="btn btn-primary" type="submit" id="saveBtn" value="submit">{{__('messages.web.confirm_booking')}}
    </button>
</div>
</div>