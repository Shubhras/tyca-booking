...
<footer class="footer-padding" style="background-color:#273432">
    <div class="container footer-width">
        <div class="row padding-10">
            <div class="col-lg-6 col-md-6 padding-10 text-center">
                <h2 class="text-white  footer-font   heading-title"> © {{ date('Y') }} Cover Projects Pte Ltd</h2>
            ...
            <div class="d-flex align-items-center footer-info__block mb-3 pb-1 pb-xxl-4">
                ...
                <a href="mailto:{{getSettingValue('email')}}" class="text-decoration-none text-white footer-info__contact-label">
    ...
    <div class="col-lg-6 col-md-6 padding-10 text-center">
        <h2 class="text-white footer-font  heading-title">All Rights Reserved</h2>
        {{-- <ul>
                    <li>
        ...
        <li>
            <a href="{{ route('medicalContact') }}" class="text-decoration-none  mb-2 d-block fw-light {{ Request::is('medical-contact*') ? 'text-black' : 'text-white' }}" data-turbo="false">{{ __('messages.web.contact_us') }}</a>
        </li>
        <li>
            <a href="{{ route('front.faqs') }}" class="text-decoration-none mb-2 d-block fw-light {{ Request::is('faqs*') ? 'text-black' : 'text-white' }}">{{ __('messages.web.faqs') }}</a>
        </li>
        <li>
            <a href="{{ route('terms.conditions') }}" class="text-decoration-none mb-2 d-block fw-light {{ Request::is('terms-conditions*') ? 'text-black' : 'text-white' }}">{{ __('messages.terms_conditions') }}</a>
        </li>
        <li>
            <a href="{{ route('privacy.policy') }}" class="text-decoration-none mb-2 d-block fw-light {{ Request::is('privacy-policy*') ? 'text-black' : 'text-white' }}">{{ __('messages.privacy_policy') }}</a>
        </li>
        </ul>--}}
    </div>
    ...
    <div class="container social-width ">
        <div class="row justify-content-center">
            <div class="col-4 text-center padding-10" style="margin-bottom:5px;">
                <a class="social-icon aaa icon" href="https://www.facebook.com/tyca.sg">
                    <i aria-hidden="true" class="fab fa-facebook-square" style="width:1em;"></i></a>
            </div>
            <div class="col-4 text-center padding-10" style="margin-bottom:5px;">
                <a class="social-icon aaa icon" href="https://instagram.com/tyca.sg">
                    <i aria-hidden="true" class="fab fa-instagram" style="width:1em;"></i></a>
            </div>
            <div class="col-4 text-center padding-10" style="margin-bottom:5px;">
                <a class="social-icon aaa icon" href="https://tiktok.com/@tyca.sg">
                    <i aria-hidden="true" class="fab fa-tiktok" style="width:1em;"></i></a>
            </div>
        </div>
    </div>
