            ...
            <div class="card-body">
                ...
                <div class="row mb-6">
                    <label for="appLogoPreview"
                        class="col-lg-4 required form-label">{{ __('messages.setting.logo').':'}}</label>
                    <div class="col-lg-8">
                            ...
                            <div class="d-block">
                                <div class="image-picker">
                                    ...
                                    <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                        ...
                                        data-bs-original-title="{{ __('messages.setting.change_app_logo') }}">
                                        <label>
                                            <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                                            <input type="file" id="logo" name="logo" class="image-upload d-none"
                                                accept="image/*" />
                                        </label>
                                    </span>
                                </div>
                ...
                <div class="row mb-6">
                    <label for="faviconPreview" class="col-lg-4 required form-label">
                            ...
                            <div class="d-block">
                                <div class="image-picker">
                                    ...
                                    <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                        ...
                                        <label>
                                            <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                                            <input type="file" id="favicon" name="favicon" class="image-upload d-none"
                                                accept="image/*" />
                                        </label>
                                    </span>
                                </div>
