                ...
                if (count($user1->gallery) == '2') { ?>
                    <div class="col-md-12 img-book">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <figure class="effect-chico">
                                    <img src="{{$user1->gallery[1]}}" alt="#" style="width:100%;height:100%" class="book-set">
                                </figure>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4 img-book">
                            <div class="row">
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <div class="grid">
                                        <figure class="effect-chico">
                                            <img src="{{$user1->gallery[2]}}" alt="#" style="width:100%;height:100%" class="book-set">
                                        </figure>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="blog-text">
                                <h1 class="font-700 roboto-font">
                                    <h1 class="location1">
                                        ...
                                        <div>
                                            <p class="location">
                                                <img src="/assets/image/material-symbols_location-on.png" alt="#" style="height: 34px; width:34px; margin-left:-5px;">
            ...
            <div class="row col-12 list-box">
                ...
                <div class="col-5 row list-box list-margin">
                    ...
                    <div class="text-xl-start header-btn-grp set-padding" style="margin-left: -11px;">
                        {{-- @if(getLogInUser())--}}
                        <button class="btn1 btn1-primary1 btn-sm me-3 me-xxl-4 rounded-2 active hour-view" data-bs-toggle="modal" data-bs-target="#hour_plan_modal" onclick="displayMessage(1,'{{ $service->charges }}','{{$service->id}}');">
                        ...
                        @endif
                        @if(getLogInUser()) --}}
                        <button class="btn1 btn1-primary1 btn-sm me-xxl-3 me-3 me-xxl-4 rounded-2 mb-xl-0 hour-view" data-bs-toggle="modal" data-bs-target="#hour_plan_modal" onclick="displayMessage(2,'{{ $service->charges_daily }}','{{$service->id}}');">
                        ...
                        ?>
                        <a class="btn11 btn1-primary11 btn-sm me-xxl-0 me-0 rounded-2 mb-xl-0 view-set" href="{{$idGet}}/hot-desk/{{$service->id}}">
                            View More
                        </a>
                    </div>
                </div>
