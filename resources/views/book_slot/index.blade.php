...
<section class="main-block1 gray">
    <div class="container">
        <div class="row col-12 slot-margin">
            <div class="grid">
                <?php if (count($user1->gallery) == '1') { ?>
                <div class="col-md-12 img-book main-img">
                    <figure class="effect-chico">
                        <img src="{{$user1->gallery[0]}}" alt="#" class="book-set first-img">
                    </figure>
                </div>

                <?php  }
                if (count($user1->gallery) == '2') { ?>
                <div class="col-md-12 img-book main-img">
                    <div class="row">
                        <div class="col-md-8">
                            <figure class="effect-chico">
                                <img src="{{$user1->gallery[0]}}" alt="#" class="book-set sec-img">
                            </figure>
                        </div>
                        <div class="col-md-4">
                            <figure class="effect-chico">
                                <img src="{{$user1->gallery[1]}}" alt="#" class="book-set sec-img">
                            </figure>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 img-book">
                        <div class="row">
                            ...
                            <div class="col-md-12 ">
                                ...
                                <div class="grid">
                                    <figure class="effect-chico">
                                        <img src="{{$user1->gallery[2]}}" alt="#" class="book-set sec-img">
                                    </figure>
                                </div>
                            </div>
                        </div>
...
<!-- <section class="ww">
    <div class="container">
    <div class="row col-12 slot-margin">
        <div class="col-md-8 img-book" style="height: 30vw;">
            <div class="grid">
                <div class="effect-chico">
                    <img src="/assets/image/image 34.png" alt="#" style="width:100%;height:30vw" class="book-set">
                </div>
            </div>
        </div>
        <div class="col-md-4 img-book" style="height: 30vw;">
            <div class="row">
                <div class="col-md-12">
                    <div class="grid">
                        <div class="effect-chico">
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="grid">
                        <div class="effect-chico" style="margin-top:18px;">
                            ...
                            <div class="blog-text">
                                <h1 class="font-700 roboto-font">
                                    <h1 class="location1">
                                        ...
                                        $doctorDescriptionWithClass = str_replace('<p>', '<p class="custom-p-class">', $doctorDescription);
                                        echo $doctorDescriptionWithClass;
                                        ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="widget-box" style="margin-bottom:60px;">
                            ...
                            @for($day = 1; $day <= 7; $day++) @php $found=false; @endphp @foreach($var_dump as $data)
                                ...
                                <div class="row mt-10 mb-2" style="display:flex;">
                                    ...
                                    <div class="col col-lg-8" style="padding-right:0px; padding-left:0px;">
                        ...
                        <div class="col-md-7 text-left col-sm-7 col-xs-12 xs-text-center">
                            <div class="column">
                                ...
                                <div class="col-3 hosts">
                                    <span
                                        style="background-color: transparent;color: #5c5c5c !important; font-family:Poppins;">
            ...
            <div class="modal-body">
                ...
                <form class="book-appointment-form bg-white" id="frontAppointmentBook"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 name-details">
                            <div class="form-group">
                                <label class="form-label" for="template-medical-first_name">{{
                                    __('messages.patient.first_name') }}:<span class="required"></span></label>
                        ...
                        <div class="col-lg-6 name-details">
                            <div class="form-group">
                                <label class="form-label" for="template-medical-last_name">{{
                                    __('messages.patient.last_name') }}:<span class="required"></span></label>
                        ...
                        <div class="col-lg-6 name-details">
                            <div class="form-group">
                                <label class="form-label" for="template-medical-last_name">{{
                                    __('messages.patient.last_name') }}:<span class="required"></span></label>
                                <input type="text" id="template-medical-last_name" name="last_name" class="form-control"
                                    value="" placeholder="{{ __('messages.doctor.last_name') }}">
                            </div>
                        </div>
                        @endif
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-label" for="template-medical-email">{{ __('messages.patient.email')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="email" id="template-medical-email" name="email" class="form-control"
                                    value="" placeholder="{{ __('messages.web.email') }}">
                            </div>
                        </div>
                        @endif
                        {{-- @if(getLogInUser()) --}}
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                {{ Form::select('doctor_id', $appointmentDoctors,
                                isset(session()->get('data')['doctor_id']) ? session()->get('data')['doctor_id'] :
                                $doctor->id,['class' => 'form-select', 'id' => 'appointmentDoctorId',
                                'data-control'=>"select2",'placeholder' => __('messages.common.select_doctor')]) }}
                            </div>
                        </div>
                        {{-- @endif --}}
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-label" for="Service">Booking Space: <span
                                        class="required"></span></label>
                                {{ Form::select('service_id', isset(session()->get('data')['service']) ?
                                session()->get('data')['service'] : [] , isset(session()->get('data')['service_id']) ?
                                session()->get('data')['service_id'] : '',['class' => 'form-select',
                                'data-control'=>"select2", 'id'=> 'FrontAppointmentServiceId','placeholder' =>
                                __('messages.common.select_service') ]) }}
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            {{ Form::text('plan_type', null, ['class' => 'form-control','required', 'id' =>
                            'adminAppointmentPlanId','placeholder' => __('Plan Type'),'readonly']) }}
                        </div>
                    ...
                    <div class="col-lg-6 d-none registered-patient">
                        <div class="form-group">
                            <label class="form-label" for="template-medical-first_name">{{
                                __('messages.web.patient_name') }}:</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="position-relative">
                                <input type="text" id="templateAppointmentDate" name="date"
                                    ...
                                    value="{{  isset(session()->get('data')['date']) ? session()->get('data')['date'] : now()->format('d-m-Y') }}"
                    ...
                    <div class="col-12" id="slot_option">
                        <div class="form-group">
                            <div class="d-flex align-items-center">
                                {{ Form::label('Available Slots',__('messages.appointment.available_slot').':' ,['class'
                                => 'form-label me-3 required']) }}
                                <div class="d-flex align-items-center">
                    ...
                    {{--<div>
                        ...
                        <div class="" style="font-size:18px; text-align:center; font-weight:500;">
                            If you book more than {{$rateDis->above_count}} then you will get {{$rateDis->rate}}%
                            discount
                        </div>
                        @endforeach
                    </div>--}}
                    ...
                    <div  id="planSet">
                        <div style="display:flex; font-size:18px;">If you book more&nbsp;
                        <div id="rrrr"></div>&nbsp;
                        then you will get&nbsp;<div id="rrrr1">
        ...
        $('body').on('click', '.applyBtn', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    const responseMulti = response;
                    aaaaaaaa(responseMulti);
            ...
            function aaaaaaaa(element) {
                ...
                for (let i = 0; i < element.length; i++) {
                    ...
                    if (element1.discount_type == "daily") {
                        if (element1.above_count <= daysDiff) {
                            var sd = price * element1.rate / 100;
                            var rateShow = element1.above_count;
                            var aboveRate = element1.rate
                            if (daysDiff == 0) {
                                $('#payable_amount_Show').text(price * 1 - sd);
                                $('#rrrr').text(rateShow);
                                $('#rrrr1').text(aboveRate);
                                var cc = (price * 1 - sd);
                                $("#payable_amount").empty().val(cc);
                            } else {
                                $('#payable_amount_Show').text(price * daysDiff -sd);
                                $('#rrrr').text(rateShow);
                                $('#rrrr1').text(aboveRate);
                                var cc = (price * daysDiff - sd);
                                $("#payable_amount").empty().val(cc);
                            }
                        }
                        else {
