<div class="d-flex justify-content-center">
    ...
    <a href="{{ route('doctors.edit', $row->id) }}" title="{{ __('messages.common.edit') }}" class="btn px-2 text-dark fs-2 doctor-edit-btn" data-bs-toggle="tooltip"
       data-bs-original-title="Edit" data-turbolinks="false">
        <i class="fa-solid fa-pen-to-square"></i>
    </a>
    <a href="javascript:void(0)" data-id="{{ $row->id }}" title="{{ __('messages.common.delete') }}" class="btn px-2 text-dark fs-2 doctor-delete-btn" data-bs-toggle="tooltip"
