...
<div class="row">
                ...
                <div class="col-xxl-6 mb-7 d-sm-flex align-items-center mb-3">
                    <div class="col-xl-4 col-lg-4 col-md-2 col-sm-12 col-xs-12">
                        <label class="form-check">
                            <input class="form-check-input form-check1 feature mx-2"
                                <?php if(isset($dayArray[1]['day_of_week']) =='1'){ echo 'checked'; } ?> type="checkbox"
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-2  col-sm-12 col-xs-12">
                        <label class="form-check">
                            <input class="form-check1 form-check-input feature mx-2" type="checkbox" value="2"
                                <?php if(isset($dayArray[2]['day_of_week']) =='2'){ echo 'checked'; } ?>
                                name="days[]" />TUESDAY
                        </label>
                    </div>
                    <div class="col-xl-8 col-lg-3 col-3 d-flex align-items-center buisness_end monday-form">
                        <div class="d-inline-block set-witdh-day">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-2 col-sm-12 col-xs-12">
                        <label class="form-check">
                            <input class="form-check1 form-check-input feature mx-2" type="checkbox" value="3"
                                <?php if(isset($dayArray[3]['day_of_week']) =='3'){ echo 'checked'; } ?>
                                name="days[]" />WEDNESDAY
                        </label>
                    </div>
                    <div class="col-xl-8 col-lg-3 col-3 d-flex align-items-center buisness_end monday-form">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-2 col-sm-12 col-xs-12">
                        <label class="form-check">
                            <input class="form-check-input feature mx-2" type="checkbox" value="4"
                                <?php if(isset($dayArray[4]['day_of_week']) =='4'){ echo 'checked'; } ?>
                                name="days[]" />THURSDAY
                        </label>
                    </div>
                    <div class="col-xl-8 col-lg-3 col-3 d-flex align-items-center buisness_end monday-form">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-2 col-sm-12 col-xs-12">
                        <label class="form-check">
                            <input class="form-check1 form-check-input feature mx-2" type="checkbox" value="5"
                                <?php if(isset($dayArray[5]['day_of_week']) =='5'){ echo 'checked'; } ?>
                                name="days[]" />FRIDAY
                        </label>
                    </div>
                    <div class="col-xl-8 col-lg-3 col-3 d-flex align-items-center buisness_end monday-form">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-2 col-sm-12 col-xs-12">
                        <label class="form-check">
                            <input class="form-check1 form-check-input feature mx-2" type="checkbox" value="6"
                                <?php if(isset($dayArray[6]['day_of_week']) =='6'){ echo 'checked'; } ?>
                                name="days[]" />SATURDAY
                        </label>
                    </div>
                    <div class="col-xl-8 col-lg-3 col-3 d-flex align-items-center buisness_end monday-form">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-2 col-sm-12 col-xs-12">
                        <label class="form-check">
                            <input class="form-check1 form-check-input feature mx-2" type="checkbox" value="7"
                                <?php if(isset($dayArray[7]['day_of_week']) =='7'){ echo 'checked'; } ?>
                                name="days[]" />SUNDAY
                        </label>
                    </div>
                    <div class="col-xl-8 col-lg-3 col-3 d-flex align-items-center buisness_end monday-form">
    ...
    ?>
                        ...
                        <button type="button" class="delete" data-filename="<?php echo $filename[5]; ?>"
                            data-id="<?php echo $filename[4]; ?>"><span>×</span>
                        </button>
                    </div>
                    <?php } ?>
