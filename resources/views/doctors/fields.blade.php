...
<div class="col-md-12">
    ...
    <div class="col-xxl-6 mb-7 d-sm-flex align-items-center mb-3">
            ...
            <div class="col-xxl-6 mb-7 d-sm-flex align-items-center mb-3">
                <div class="col-xl-4 col-lg-4 col-md-2 col-4">
                    <label class="form-check">
                        <input class="form-check-input feature mx-2" type="checkbox" value="2"
                               name="days[]" />TUESDAY
                    </label>
                </div>
                <div class="col-xl-8 col-lg-3 col-3 d-flex align-items-center buisness_end">
            ...
            <div class="col-xxl-6 mb-7 d-sm-flex align-items-center mb-3">
                <div class="col-xl-4 col-lg-4 col-md-2 col-4">
                    <label class="form-check">
                        <input class="form-check-input feature mx-2" type="checkbox" value="3"
                               name="days[]" />WEDNESDAY
                    </label>
                </div>
                <div class="col-xl-8 col-lg-3 col-3 d-flex align-items-center buisness_end">
                    <div class="d-inline-block">
                        <select class="form-control " data-control="select2" name="startTime[3]" tabindex="-1" aria-hidden="true"><option value="" data-select2-id="select2-data-6-zpds">Select Time</option>
                            <?php foreach($slots as $slot){   ?>
                                <option value="<?php echo $slot; ?>" <?php if($slot == isset($dayArray[2]['start_time'])) { echo 'selected'; } ?>><?php echo $slot; ?></option>
                            <?php } ?>
                        </select>
                    ...
                    <span class="px-3">To</span>
                    <div class="d-inline-block">
                    <select class="form-control " data-control="select2" name="endTime[3]"  tabindex="-1" aria-hidden="true"><option value="" data-select2-id="select2-data-6-zpds">Select Time</option>
                        <?php foreach($slots as $slot){   ?>
                            <option value="<?php echo $slot; ?>" <?php if($slot == isset($dayArray[2]['start_time'])) { echo 'selected'; } ?>><?php echo $slot; ?></option>
                        <?php } ?>
                    </select>
            ...
            <div class="col-xxl-6 mb-7 d-sm-flex align-items-center mb-3">
                <div class="col-xl-4 col-lg-4 col-md-2 col-4">
                    <label class="form-check">
                        <input class="form-check-input feature mx-2" type="checkbox" value="4"
                               name="days[]" />THURSDAY
                    </label>
                </div>
                <div class="col-xl-8 col-lg-3 col-3 d-flex align-items-center buisness_end">
                    ...
                    <span class="px-3">To</span>
                    <div class="d-inline-block">
                    <select class="form-control " data-control="select2" name="endTime[4]"  tabindex="-1" aria-hidden="true"><option value="" data-select2-id="select2-data-6-zpds">Select Time</option>
                        <?php foreach($slots as $slot){   ?>
                            <option value="<?php echo $slot; ?>" <?php if($slot == isset($dayArray[2]['start_time'])) { echo 'selected'; } ?>><?php echo $slot; ?></option>
                        <?php } ?>
                    </select>
            ...
            <div class="col-xxl-6 mb-7 d-sm-flex align-items-center mb-3">
                <div class="col-xl-4 col-lg-4 col-md-2 col-4">
                    <label class="form-check">
                        <input class="form-check-input feature mx-2" type="checkbox" value="5"
                               name="days[]" />FRIDAY
                    </label>
                </div>
                <div class="col-xl-8 col-lg-3 col-3 d-flex align-items-center buisness_end">
                    <div class="d-inline-block">
                        <select class="form-control " data-control="select2" name="startTime[5]" tabindex="-1" aria-hidden="true"><option value="" data-select2-id="select2-data-6-zpds">Select Time</option>
                            <?php foreach($slots as $slot){   ?>
                                <option value="<?php echo $slot; ?>" <?php if($slot == isset($dayArray[2]['start_time'])) { echo 'selected'; } ?>><?php echo $slot; ?></option>
                            <?php } ?>
                        </select>
                    ...
                    <span class="px-3">To</span>
                    <div class="d-inline-block">
                    <select class="form-control " data-control="select2" name="endTime[5]"  tabindex="-1" aria-hidden="true"><option value="" data-select2-id="select2-data-6-zpds">Select Time</option>
                        <?php foreach($slots as $slot){   ?>
                            <option value="<?php echo $slot; ?>" <?php if($slot == isset($dayArray[2]['start_time'])) { echo 'selected'; } ?>><?php echo $slot; ?></option>
                        <?php } ?>
                    </select>
            ...
            <div class="col-xxl-6 mb-7 d-sm-flex align-items-center mb-3">
                <div class="col-xl-4 col-lg-4 col-md-2 col-4">
                    <label class="form-check">
                        <input class="form-check-input feature mx-2" type="checkbox" value="6"
                               name="days[]" />SATURDAY
                    </label>
                </div>
                <div class="col-xl-8 col-lg-3 col-3 d-flex align-items-center buisness_end">
                    <div class="d-inline-block">
                        <select class="form-control " data-control="select2" name="startTime[6]" tabindex="-1" aria-hidden="true"><option value="" data-select2-id="select2-data-6-zpds">Select Time</option>
                            <?php foreach($slots as $slot){   ?>
                                <option value="<?php echo $slot; ?>" <?php if($slot == isset($dayArray[2]['start_time'])) { echo 'selected'; } ?>><?php echo $slot; ?></option>
                            <?php } ?>
                        </select>
                    ...
                    <span class="px-3">To</span>
                    <div class="d-inline-block">
                    <select class="form-control " data-control="select2" name="endTime[6]"  tabindex="-1" aria-hidden="true"><option value="" data-select2-id="select2-data-6-zpds">Select Time</option>
                        <?php foreach($slots as $slot){   ?>
                            <option value="<?php echo $slot; ?>" <?php if($slot == isset($dayArray[2]['start_time'])) { echo 'selected'; } ?>><?php echo $slot; ?></option>
                        <?php } ?>
                    </select>
            ...
            <div class="col-xxl-6 mb-7 d-sm-flex align-items-center mb-3">
                <div class="col-xl-4 col-lg-4 col-md-2 col-4">
                    <label class="form-check">
                        <input class="form-check-input feature mx-2" type="checkbox" value="7"
                               name="days[]" />SUNDAY
                    </label>
                </div>
                <div class="col-xl-8 col-lg-3 col-3 d-flex align-items-center buisness_end">
                    <div class="d-inline-block">
                        <select class="form-control" data-control="select2" name="startTime[7]"  tabindex="-1" aria-hidden="true"><option value="" data-select2-id="select2-data-6-zpds">Select Time</option>
                            <?php foreach($slots as $slot){   ?>
                                <option value="<?php echo $slot; ?>" <?php if($slot == isset($dayArray[2]['start_time'])) { echo 'selected'; } ?>><?php echo $slot; ?></option>
                            <?php } ?>
                        </select>
                    ...
                    <span class="px-3">To</span>
                    <div class="d-inline-block">
                    <select class="form-control " data-control="select2" name="endTime[7]"  tabindex="-1" aria-hidden="true"><option value="" data-select2-id="select2-data-6-zpds">Select Time</option>
                        <?php foreach($slots as $slot){   ?>
                            <option value="<?php echo $slot; ?>" <?php if($slot == isset($dayArray[2]['start_time'])) { echo 'selected'; } ?>><?php echo $slot; ?></option>
                        <?php } ?>
                    </select>
...
<div class="col-md-6 mb-5">
    ...
    <div class="col-lg-8">
        <div class="form-check form-check-solid form-switch">
            <input tabindex="12" name="status" value="0" class="form-check-input input-switch" type="checkbox"
