<div class="row">
    ...
    <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
        ...
        <?php
        $appointment_service =  DB::table('appointments')->where('appointment_unique_id',$transaction['data']->appointment_id)->first();
        $service_data_get = DB::table('services')->where('id',$appointment_service->service_id)->first();
        $service_data = $service_data_get->name;
        ?>
        <span class="fs-4 text-gray-800"><?php echo $service_data; ?></span>
    </div>
    <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
