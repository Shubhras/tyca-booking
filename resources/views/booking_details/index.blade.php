    ...
    <div class="container">
        <div class="row booking-details">
            ...
            <div class=" col-md-6 booking-details-left">
                ...
                <div class="mb-1">
                @if($AppointData->plan_type == "hourly")
                ...
                @endif
                <div class="mb-1">
                    <span class="heading">Payable Amount:</span> <span class="sub-head">${{$AppointData->payable_amount}}</span>
                </div>


                @if($AppointData->payment_method == 1)
                <div class="mb-1">
                    <span class="heading">Payment Method:</span> <span class="sub-head">Mannual</span>
                </div>
                @elseif($AppointData->payment_method == 2)
                <div class="mb-1">
                    <span class="heading">Payment Method:</span> <span class="sub-head">Stripe</span>
                </div>
                ...
                @else
                <div class="mb-1">
                    <span class="heading">Payment Method:</span> <span class="sub-head">NA</span>
                </div>
                @endif
                <div class="books-now">
