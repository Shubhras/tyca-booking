<div class="row">
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::text('first_name', isset($staff) ? $staff->first_name : null, ['class' => 'form-control', 'placeholder' => __('messages.patient.first_name'), 'required', 'pattern' => '[A-Za-z]+', 'title' => 'Please enter alphabetic characters only']) }}
        </div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::text('last_name', isset($staff) ? $staff->last_name : null, ['class' => 'form-control', 'placeholder' => __('messages.patient.last_name'), 'required','pattern' => '[A-Za-z]+', 'title' => 'Please enter alphabetic characters only']) }}
        </div>
    </div>
